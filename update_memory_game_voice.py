...
function MemoryGame({ onExit }) {
  ...
  // Speak when phase changes to 'show' or 'select'
  useEffect(() => {
    if (phase === 'show') {
      speak('Remember these objects.');
    } else if (phase === 'select') {
      speak('Which objects did you see? Select all that you remember.');
    } else if (phase === 'finished') {
      speak(`Game over. You got ${score.correct} correct and ${score.wrong} wrong.`);
    }
